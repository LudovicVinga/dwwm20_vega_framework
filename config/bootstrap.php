...
use Symfony\Component\Dotenv\Dotenv;
     ...
     *          - S'assurer que les variables d'environnement indispensables soient disponibles
     * 
     * *********************************************************************************
     */

    // Chargement  de l'autochargeur des classes composer
    ...
    {
        throw new RuntimeException(sprintf("The dotenv file does not exist. Create this '.env' file in the root of vega"));
    }
    ...
    if( !isset($_ENV['APP_DEBUG']) || empty($_ENV['APP_DEBUG']) || !in_array($_ENV['APP_DEBUG'], ['0', 'flase', '1', 'true']) )
    {
