...
abstract class Kernel implements KernelInterface
{
    ...
    /**
     * Mode débuggage de l'application.
     *
     * @var boolean
     */
    ...
    /**
     * Soumettre la requête de la part du contrôleur frontal pour traitement 
    ...
    /**
     * Permettre de savoir si le mode débuggage est activé ou non.
     *
     * @return boolean
     */
     ...
     * @return string
     */
    public function loadRessource(string $ressourceName): string
    {
